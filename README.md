...
This version is edited to work with the [diagram application](https://openscop.dev/Laurent/taiga-diagram).  
Author: [Laurent Cantos](https://laurentcantos.fr/), my [Github](https://github.com/LaurentCNS).
